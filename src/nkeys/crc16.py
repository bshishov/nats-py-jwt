# see: https://github.com/nats-io/nkeys/blob/main/crc16.go
from typing import Union

__all__ = ["crc16", "validate"]
...
def crc16(data: Union[bytes, memoryview]) -> bytes:
...
def validate(
    data: Union[bytes, memoryview], expected: Union[bytes, memoryview]
) -> bool:
